    ...
    */
    ...
    public class DogTableTest
    {
        ...
        public void Create_ValidData_DogIDReturned()
        {
            ...
            dogModel.name = "Ted";
            dogModel.regularQualificationAchieved = false;
            dogModel.experienceForAdvancedProgram = false;
            dogModel.experience = "None";
...
public void Read_CreatedAndRead1Record_CorrectValues()
{
   ...
   Assert.AreEqual(dogModel.regularQualificationAchieved, actual.regularQualificationAchieved);
   Assert.AreEqual(dogModel.experienceForAdvancedProgram, actual.experienceForAdvancedProgram);
    Assert.AreEqual(dogModel.experience, actual.experience);
}
...
public void ReadAll_Create3Records_CountIs3()
{
   ...
   dogModel1.name = "Ted";
   dogModel1.regularQualificationAchieved = false;
   dogModel1.experienceForAdvancedProgram = false;
   dogModel1.experience = "None";

   DogModel dogModel2 = new DogModel();
   dogModel2.name = "Ted";
   dogModel2.regularQualificationAchieved = false;
   dogModel2.experienceForAdvancedProgram = false;
   dogModel2.experience = "None";

   DogModel dogModel3 = new DogModel();
   dogModel3.name = "Ted";
   dogModel3.regularQualificationAchieved = false;
   dogModel3.experienceForAdvancedProgram = false;
   dogModel3.experience = "None";
